...
public class CodeGenerator {
    ...
    public void generateCode() {
        // 包路径
        String packageName = "com.jonas";

        //子工程的名称
        String projectName = "shiro";

        generateByTables(projectName, packageName, "sys_permission", "sys_role", "sys_role_permission", "sys_user_role");
    }

    private void generateByTables(String projectName, String packageName, String... tableNames) {

        // 数据库信息
        String dbUrl = "jdbc:mysql://shenjy.club:3306/dev";
...
//                .setLogicDeleteFieldName("delete") // 逻辑删除属性名称
